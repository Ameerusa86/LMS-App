...
import { useSession, signOut } from "next-auth/react"; // Import useSession and signOut for logout functionality
          ...
          <div className="mt-2 bg-white shadow-lg rounded-lg p-4">
            <ul className="space-y-2">
              ...
              <li
                ...
                onClick={handleLogout} // Attach logout function to button
              >
                Logout
              </li>
            </ul>
